...
urlpatterns = [
    ...
    path('customer_receipt/<int:customer_id>/<int:priod>', views.customer_receipt, name='customer_receipt'),        
    path('total_inv_rec_report', views.total_inv_rec_report, name='total_inv_rec_report'),        
    path('customer_balance/<int:customer_id>/<int:priod>/<int:year>', views.customer_balance, name='customer_balance'),        
